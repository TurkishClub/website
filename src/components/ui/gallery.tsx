...
export const PhotoGallery = ({
  ...
  // Animation settings for each photo
  ...
  return (
    <div className="mt-20 relativ bg-[#C61E1E]">
      <div className="absolute inset-0 max-md:hidden top-[200px] -z-10 h-[300px] w-full bg-transparent bg-[size:3rem_3rem] opacity-20 [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)] dark:bg-[linear-gradient(to_right,#a8a29e_1px,transparent_1px),linear-gradient(to_bottom,#a8a29e_1px,transparent_1px)]"></div>
      <p className="lg:text-md my-2 text-center text-xs font-light uppercase tracking-widest text-slate-100 dark:text-slate-400">
        Turkish Club&apos;da ne yapıyoruz?
      </p>
      <h3 className="z-20 mx-auto max-w-2xl justify-center bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 bg-clip-text py-3 text-center text-4xl text-transparent dark:bg-gradient-to-r dark:from-slate-100 dark:via-slate-200 dark:to-slate-100 dark:bg-clip-text md:text-7xl">
        <span className="text-rose-100">Anılarımız</span>
      </h3>
              ...
              {[...photos].reverse().map((photo) => (
                <motion.div
                  ...
                  animate={{
                    ...
                    rotate: 0,
                    scale: 1,
                    transition: {...springTransition, delay: photo.order * 0.15}
                  }}
                >
                  <Photo
                    width={220}
      ...
      <div className="flex w-full justify-center">
        <Button
          onClick={() =>
            router.push('https://www.instagram.com/turkishclub.munich/')
          }
        >
          Visit Our Instagram
        </Button>
...
const MotionImage = motion(
  forwardRef(function MotionImage(
    ...
    return <Image ref={ref} {...props} alt={props.alt || 'Motion image'} />;
  })
);
