...
function Feature({ theme = 'red' }: FeatureProps) {
  ...
  const themes = {
    ...
    white : 
    {
      ...
      cardHoverBg: 'hover:bg-black',
      cardHoverBorder: 'hover:border-black',
      iconDefault: 'text-black',
      iconHover: 'group-hover:text-white',
      iconActive: 'text-white',
      titleDefault: 'text-black',
      titleHover: 'group-hover:hidden',
      textDefault: 'text-black/70',
      bulletColor: 'text-black',
      activeCardBg: 'bg-black',
      activeCardBorder: 'border-black'
    }
  };
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col gap-8 lg:gap-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
            {/* Software Team */}
            <div 
              className={`group ${t.cardBg} backdrop-blur-sm border ${t.cardBorder} rounded-lg p-4 lg:p-6 flex justify-between flex-col min-h-[200px] lg:min-h-[250px] transition-all duration-700 ${t.cardHoverBg} ${t.cardHoverBorder} hover:scale-105 cursor-pointer overflow-hidden relative ${activeCard === 0 ? `${t.activeCardBg} ${t.activeCardBorder} scale-105` : ''}`}
            ...
            {/* Content Team */}
            <div 
              className={`group ${t.cardBg} backdrop-blur-sm border ${t.cardBorder} rounded-lg p-4 lg:p-6 flex justify-between flex-col min-h-[200px] lg:min-h-[250px] transition-all duration-700 ${t.cardHoverBg} ${t.cardHoverBorder} hover:scale-105 cursor-pointer overflow-hidden relative ${activeCard === 1 ? `${t.activeCardBg} ${t.activeCardBorder} scale-105` : ''}`}
            ...
            {/* Social Media Team */}
            <div 
              className={`group ${t.cardBg} backdrop-blur-sm border ${t.cardBorder} rounded-lg p-4 lg:p-6 flex justify-between flex-col min-h-[200px] lg:min-h-[250px] transition-all duration-700 ${t.cardHoverBg} ${t.cardHoverBorder} hover:scale-105 cursor-pointer overflow-hidden relative ${activeCard === 2 ? `${t.activeCardBg} ${t.activeCardBorder} scale-105` : ''}`}
            ...
            {/* Events Team */}
            <div 
              className={`group ${t.cardBg} backdrop-blur-sm border ${t.cardBorder} rounded-lg p-4 lg:p-6 flex justify-between flex-col min-h-[200px] lg:min-h-[250px] transition-all duration-700 ${t.cardHoverBg} ${t.cardHoverBorder} hover:scale-105 cursor-pointer overflow-hidden relative ${activeCard === 3 ? `${t.activeCardBg} ${t.activeCardBorder} scale-105` : ''}`}
