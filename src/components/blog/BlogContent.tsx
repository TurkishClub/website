              ...
              <div className="flex-1 w-full">
                <div className="relative">
                  <Input
                    ...
                    className="pl-4 pr-4 py-3 w-full text-base border-gray-300 focus:border-[#C61E1E] focus:ring-[#C61E1E] rounded-lg"
                  />
                </div>
              </div>
            </div>
          ...
          {filteredPosts.length > 0 ? (
            <>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4 -mt-8">
                <p className="text-gray-200">
                  {t('results.showing', {
                    count: filteredPosts.length.toString()
                  })}
            ...
            <div className="text-center py-16 -mt-8">
              ...
              <p className="text-gray-200 mb-6">
                {searchTerm
                  ? t('results.noResultsFor', {searchTerm})
